        ...
        hooks = [
          {
            ...
            prompt = ''
              ...
              If it is a single, simple command with no pipes, chaining, subshells, or interpreter scripts: return {"ok": true}
              ...
              4. If MORE than 3 sentences are needed: return {"ok": false, "reason": "Too complex: this command has [N] parts and needs [N] sentences to explain. Break it into separate, simpler commands."}
