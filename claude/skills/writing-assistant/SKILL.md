...
Process the document sequentially. For each section:
...
- If the outline is long, work through it one paragraph at a time
...
- Work incrementally — make one edit, move on to the next, don't batch
