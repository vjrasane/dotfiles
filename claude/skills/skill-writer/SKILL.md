...
**Global Skills** (`~/dotfiles/claude/skills/`):
...
- Shared utilities (committed to the project's git repo)
...
```bash
# Global (managed by Home Manager, symlinked to ~/.claude/skills/)
...
2. **Check file location**:
   ```bash
   # Global skills (source managed by Home Manager)
   ls ~/dotfiles/claude/skills/skill-name/SKILL.md
